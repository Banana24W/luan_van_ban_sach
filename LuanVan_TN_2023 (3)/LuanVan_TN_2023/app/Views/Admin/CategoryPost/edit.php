                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-block">
                                            <div class="edit-info">
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <form action="<?= base_url('dashboard/categorypost/update/'.$categorypost['ma_loai_bai_viet']) ?>" method="post">
                                                            ...
                                                            <div class="general-info">
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <div class="input-group">
                                                                            <input type="text" class="form-control" value="<?= $categorypost['ten_loai_bai_viet'] ?>" id="name" name="name" placeholder="Tên ..." required autofocus>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <div class="input-group">
                                                                            <select name="status" class="form-control" required>
                                                                                ...
                                                                                <?php  if($categorypost['status'] == 1): ?>
                                                                                    <option value="1" checked selected >Hiển thị</option>
                                                                                    <option value="0">Ẩn</option>
                                                                                <?php endif ?>
                                                                                <?php  if($categorypost['status'] == 0): ?>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12 text-right">
                                                                        ...
                                                                        <a href="<?= base_url('dashboard/categorypost/detail') ?>" id="edit-cancel" class="btn btn-default waves-effect">Huỷ</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <!-- end of edit info -->
