                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-block">
                                            <div class="edit-info">
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <form action="<?= base_url('dashboard/role/update/'.$role['role_id']) ?>" method="post">
                                                            <input type="hidden" name="id" value="">
                                                            <div class="general-info">
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <label for="username">Tên Cấp Bậc</label>
                                                                        <div class="input-group">
                                                                            <input type="text" class="form-control" value="<?= $role['role_name'] ?>" id="name" name="name" placeholder="Tên ..." required autofocus>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12 text-right">
                                                                        ...
                                                                        <a href="<?= base_url('dashboard/nxb/detail') ?>" id="edit-cancel" class="btn btn-default waves-effect">Huỷ</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <!-- end of edit info -->
