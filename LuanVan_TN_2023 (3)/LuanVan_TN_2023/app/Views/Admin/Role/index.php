                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="card">
                                ...
                                <a href="<?=base_url('dashboard/role/detail')?>"><button style="float: right;" class="btn btn-primary waves-effect waves-light m-r-10">Thêm Cấp Bậc</button></a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div style="width: 90px;" class="btn-group btn-group-sm">
                                                        <a href ="<?= base_url('dashboard/role/edit/'.$item['role_id']) ?>"  style="margin: 4px;"  class="tabledit-edit-button btn btn-primary waves-effect waves-light">
                                                            <span class="icofont icofont-ui-edit"></span>
                                                        </a>
                                                        <a href ="<?= base_url('dashboard/role/delete/'.$item['role_id']) ?>" style="margin: 4px;" onclick="delete_account()" class="tabledit-delete-button btn btn-danger waves-effect waves-light">
