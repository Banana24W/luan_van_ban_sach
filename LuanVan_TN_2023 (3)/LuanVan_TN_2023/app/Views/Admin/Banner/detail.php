                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="product-edit">
                                            <form class="md-float-material card-block" id="j-forms" action="<?= base_url('dashboard/banner/manage/save') ?>" method="POST" enctype="multipart/form-data">
                                                <input type="hidden" name="banner_id" value="<?= !empty($banner['ma_banner']) ? $banner['ma_banner'] : '' ?>">
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <select name="status" class="form-control" required>
                                                            <?php foreach (PRODUCT_STATUS as $key => $val) : ?>
                                                                <option value="<?= $key ?>" <?= !empty($banner['status'])  && $banner['status'] == $key ? 'selected' : '' ?>><?= $val ?></option>
                                                            <?php endforeach ?>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-12">
                                                        ...
                                                        <?php if (!empty($banner['hinh_anh'])) : ?>
                                                            <ul id="product-image" class="jFiler-items-list jFiler-items-default">
                                                                <li class="jFiler-item" data-jfiler-index="0" id="img-<?= !empty($banner['ma_banner']) ? $banner['ma_banner'] : set_value('ma_banner') ?>">
                                                                    <div class="jFiler-item-container">
                                                                        <div class="jFiler-item-inner">
                                                                            ...
                                                                            <div class="jFiler-item-info pull-left">
                                                                                <div class="jFiler-item-title" title="<?= $banner['hinh_anh'] ?>">
                                                                                    <a href="<?= base_url('uploads/banner/' . $banner['hinh_anh']) ?>" target="_blank" rel="noopener noreferrer">
                                                                                        <?= $banner['hinh_anh'] ?>
                                                                                    </a>
                                                                                </div>
                                                                                <div class="jFiler-item-others">
                                                                                    <span><?= @get_file_size(BANNER_IMAGE_PATH . $banner['hinh_anh'], 2) ?? 0 ?> MB</span>
                                                                                    <span>type: <?= @getimagesize(BANNER_IMAGE_PATH . $banner['hinh_anh'])['mime'] ?? 'unknown' ?></span>
