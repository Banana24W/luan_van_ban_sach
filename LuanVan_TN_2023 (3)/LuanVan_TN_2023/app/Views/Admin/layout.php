...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>\templates\libraries\bower_components\datatables.net-responsive-bs4\css\responsive.bootstrap4.min.css">
    <!-- Notification.css -->
...
<body>
    ...
    <!-- data-table js -->
    <script src="<?= base_url() ?>\templates\libraries\bower_components\datatables.net\js\jquery.dataTables.min.js"></script>
    <script src="<?= base_url() ?>\templates\libraries\bower_components\datatables.net-buttons\js\dataTables.buttons.min.js"></script>
    <script src="<?= base_url() ?>\templates\libraries\assets\pages\data-table\js\jszip.min.js"></script>
    <script src="<?= base_url() ?>\templates\libraries\assets\pages\data-table\js\pdfmake.min.js"></script>
    <script src="<?= base_url() ?>\templates\libraries\assets\pages\data-table\js\vfs_fonts.js"></script>
    <script src="<?= base_url() ?>\templates\libraries\bower_components\datatables.net-buttons\js\buttons.print.min.js"></script>
    <script src="<?= base_url() ?>\templates\libraries\bower_components\datatables.net-buttons\js\buttons.html5.min.js"></script>
    <script src="<?= base_url() ?>\templates\libraries\bower_components\datatables.net-bs4\js\dataTables.bootstrap4.min.js"></script>
    <script src="<?= base_url() ?>\templates\libraries\bower_components\datatables.net-responsive\js\dataTables.responsive.min.js"></script>
    <script src="<?= base_url() ?>\templates\libraries\bower_components\datatables.net-responsive-bs4\js\responsive.bootstrap4.min.js"></script>
    <!-- notification js -->
    ...
    <!-- i18next.min.js -->
    <script type="text/javascript" src="<?= base_url() ?>\templates\libraries\bower_components\i18next\js\i18next.min.js"></script>
    <script type="text/javascript" src="<?= base_url() ?>\templates\libraries\bower_components\i18next-xhr-backend\js\i18nextXHRBackend.min.js"></script>
    ...
    <!-- ajax -->
    <!-- Chart js -->
    <script type="text/javascript" src="<?= base_url() ?>\templates\js\js\Chart.js"></script>
