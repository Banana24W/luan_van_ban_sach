                                        ...
                                        <?php if (isset($user) || !empty($user)) : ?>
                                            ...
                                            <tr>
                                                ...
                                                <div class="checkbox-fade fade-in-primary d-flex justify-content-center">
                                                                    <label>
                                                                        <input type="checkbox" id="checkbox2" name="status" value="" <?= $item['status'] == 3 ? 'checked' : '' ?>>
                                                                        <span class="cr">
                                                ...
                                                <div class="btn-group btn-group-sm">
                                                                    <a style="margin: 4px;" href="<?= base_url('dashboard/user/detail/' . $item['id']) ?>" class="tabledit-edit-button btn btn-primary waves-effect waves-light">
