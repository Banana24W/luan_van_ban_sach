                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-block">
                                            <div class="edit-info">
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <form action="<?= base_url('dashboard/nxb/update/'.$NXB['ma_nha_xuat_ban']) ?>" method="post">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <div class="input-group">
                                                                            <input type="text" class="form-control" value="<?= $NXB['ten_nha_xuat_ban'] ?>" id="name" name="name" placeholder="Tên ..." required autofocus>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
